package com.cclinux.projects.meeting.service.admin;
...
import com.cclinux.projects.meeting.comm.ProjectConfig;
...
@Service("MeetingAdminMeetService")
public class AdminMeetService extends BaseMyAdminService {
    ...
    public long insertMeet(MeetModel meet) {
        appError("{会议室}该功能暂不开放，如有需要请加作者微信：cclinux0730");
