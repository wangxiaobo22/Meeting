...
import com.cclinux.projects.meeting.service.admin.AdminMeetService;
import com.cclinux.projects.meeting.service.cust.MeetService;
...
@RestController("MeetingAdminMeetController")
public class AdminMeetController extends BaseMyAdminController {

    @Resource(name = "MeetingAdminMeetService")
