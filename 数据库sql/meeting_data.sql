...
INSERT INTO `meeting_admin` VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', NULL, 1, 1, 1, 0, 0, 0);

-- ----------------------------
-- Table structure for meeting_fav
-- ----------------------------
DROP TABLE IF EXISTS `meeting_fav`;
CREATE TABLE `meeting_fav`  (
...
-- ----------------------------
-- Table structure for meeting_meet
-- ----------------------------
DROP TABLE IF EXISTS `meeting_meet`;
...
-- ----------------------------
-- Table structure for meeting_meet_join
-- ----------------------------
DROP TABLE IF EXISTS `meeting_meet_join`;
CREATE TABLE `meeting_meet_join`  (
...
-- ----------------------------
-- Table structure for meeting_news
-- ----------------------------
DROP TABLE IF EXISTS `meeting_news`;
CREATE TABLE `meeting_news`  (
...
-- ----------------------------
-- Table structure for meeting_setup
-- ----------------------------
DROP TABLE IF EXISTS `meeting_setup`;
CREATE TABLE `meeting_setup`  (
